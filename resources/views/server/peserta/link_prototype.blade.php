	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<strong class="card-title">Link prototype (Innovative App Idea)</strong>
			</div>
			<div class="card-body">
				<div class="col-md-6 mb-3 mb-lg-0">
					...
					@endif
					<form action="{{ route('dashboard.linkPrototype') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group">
							<label for="">Link Prototype</label>
							<input type="text" name="link_prototype" class="form-control" value="{{$persyaratan != null ? $persyaratan->isi : ''}}">
